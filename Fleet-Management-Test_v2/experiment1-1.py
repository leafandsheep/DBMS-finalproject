...
try:
    ...
    # df.to_csv(r'.\experiment1_1.csv', index=False, encoding='utf-8')
    df.to_csv(r'.\experiment_test.csv', index=False, encoding='utf-8')
    print("資料已正確匯出到 experiment1_1.csv")
    # print(df)
